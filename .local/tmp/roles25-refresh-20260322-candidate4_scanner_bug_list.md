# Refresh Triage Summary (roles25-refresh-20260322-candidate4)

## Scope

- Run label: `roles25-refresh-20260322-candidate4`
- Batch id: `12`
- Targets in batch: `25`
- Exclude role name containing `dummy`: `true`
- Exclude description prefixed `DEPRECATED:`: `true`
- URL list: `.local/tmp/roles25-refresh-20260322-candidate4_urls.txt`
- Bug target TSV: `.local/tmp/roles25-refresh-20260322-candidate4_bug_targets.tsv`
...
|---:|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | https://github.com/geerlingguy/ansible-role-mysql | 34 | 118 | 0.288 | 0 | 24 | 10 | 12 |
| 2 | https://github.com/bertvv/ansible-role-bind | 33 | 72 | 0.458 | 0 | 19 | 14 | 4 |
| 3 | https://github.com/geerlingguy/ansible-role-php | 29 | 121 | 0.240 | 0 | 18 | 11 | 14 |
| 4 | https://github.com/mshurutov/pgbackup | 22 | 37 | 0.595 | 0 | 0 | 22 | 0 |
| 5 | https://github.com/geerlingguy/ansible-role-nginx | 22 | 55 | 0.400 | 0 | 13 | 9 | 1 |
| 6 | https://github.com/geerlingguy/ansible-role-postgresql | 18 | 45 | 0.400 | 0 | 11 | 7 | 9 |
| 7 | https://github.com/geerlingguy/ansible-role-apache | 15 | 52 | 0.288 | 0 | 14 | 1 | 2 |
| 8 | https://github.com/dev-sec/ansible-ssh-hardening | 12 | 101 | 0.119 | 0 | 5 | 7 | 1 |
| 9 | https://github.com/mutl3y/ansible_port_listener | 10 | 13 | 0.769 | 0 | 0 | 10 | 0 |
| 10 | https://github.com/geerlingguy/ansible-role-nodejs | 6 | 16 | 0.375 | 0 | 5 | 1 | 1 |
