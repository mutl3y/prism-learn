# Refresh Triage Summary (roles25-refresh-20260322-candidate6)

## Scope

- Run label: `roles25-refresh-20260322-candidate6`
- Batch id: `18`
- Targets in batch: `25`
- Exclude role name containing `dummy`: `true`
- Exclude description prefixed `DEPRECATED:`: `true`
- URL list: `.local/tmp/roles25-refresh-20260322-candidate6_urls.txt`
- Bug target TSV: `.local/tmp/roles25-refresh-20260322-candidate6_bug_targets.tsv`
